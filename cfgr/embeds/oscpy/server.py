...
from cfgr.embeds.oscpy import __version__
from cfgr.embeds.oscpy.parser import read_packet, UNICODE
from cfgr.embeds.oscpy.client import send_bundle, send_message
from cfgr.embeds.oscpy.stats import Stats
