...
from cfgr.embeds.python2osc.parsing import ntp
from cfgr.embeds.python2osc.parsing import osc_types
...
class TestNTPTimestamp(unittest.TestCase):
  ...
  def test_write_date(self):
    self.assertEqual(b'\x83\xaa~\x83\x00\x00\x059', osc_types.write_date(Decimal('3.1337')))
